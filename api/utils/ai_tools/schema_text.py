...
def selector_schema_for_prompt(vector_search_tables, column_description_char_limit=None):
    selector_schema = sdk_utils.readable_tables(vector_search_tables, column_description_char_limit)
