...
- ENRICH_AI(<prompt:text>):text. LLM-powered. Queries the LLM with the provided prompt. For example, you can use this to extract information from a column, like this:
